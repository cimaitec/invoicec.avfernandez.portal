...
public class FacEmpresa implements Serializable {
	...
	public String toString() {
		...
		String ls_string = "Ruc:"+ruc+"|ColorEmpresa:"+colorEmpresa+"|ContribEspecial:"+ contribEspecial+
							"|CorreoRecepcion:"+correoRecepcion+"|DireccionMatriz:"+direccionMatriz+
							"|emailEnvio:"+emailEnvio+"|isActive:"+isActive+
							"|marcaAgua:"+marcaAgua+"|ObligContabilidad:"+obligContabilidad+
							"|passSMTP:"+passSMTP+"|PathCompAutorizados:"+pathCompAutorizados+
							"|PathCompGenerados:"+pathCompGenerados+
							"|PathCompNoAutorizados:"+pathCompNoAutorizados+"|PathCompRecepcion:"+
							"|PathCompFirmados:"+pathCompFirmados+"|pathCompRecepcion:"+pathCompRecepcion+
							"|PathFirma:"+pathFirma+"|PathInfoRecibida:"+pathInfoRecibida+
							"|PathLogoEmpresa:"+pathLogoEmpresa+"|pathMarcaAgua:"+pathMarcaAgua+
							"|puertoSMTP:"+puertoSMTP+"|RazonComercial:"+razonComercial+
							"|RazonSocial:"+razonSocial+"|servidorSMTP:"+servidorSMTP+"|sslSMTP:"+sslSMTP+
							"|UrlWebServices:"+urlWebServices+"|userSMTP:"+userSMTP+
							"|PathCompContingencia:"+pathCompContingencia+"|FechaResolucionContribEspecial:"+fechaResolucionContribEspecial+			
							"|PassFirma:"+PassFirma+"|TypeFirma:"+TypeFirma+"|PathXSD:"+PathXSD+
							"|PathJasper"+PathJasper;
/*
