 ...
 */
@Embeddable
public class FacDetRetencionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FacDetRetencionPK)) {
			return false;
		}
		FacDetRetencionPK castOther = (FacDetRetencionPK)other;
		return 
