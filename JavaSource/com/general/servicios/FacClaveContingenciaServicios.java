...
public class FacClaveContingenciaServicios {
	...
	public List<FacClavescontingencia> findByClave(String claveContingencia, String ambiente) {
		Query q = em.createQuery("select E FROM FacClavescontingencia E where E.clave = :clave and E.tipo = :tipo ");
		q.setParameter("clave", claveContingencia);	
		q.setParameter("tipo", ambiente);
