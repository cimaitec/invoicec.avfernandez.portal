...
public class facDetalleDocumentoEntidad {
	...
	//String ruc, String codEstablecimiento, String codPuntoEmision, String secuencial, String codigoDocumento
	    ...
	    public facDetalleDocumentoEntidad(String RFCREC,String NOMREC,String codDoc,String TIPODOC,String FOLFAC,String TOTAL, Date FECHA,String EDOFAC,
	    		...
	    		String codigoDocumento, String secuencial, String xmlAutorizacion,String ambiente) {
	    	this.RFCREC= RFCREC;
	    	this.NOMREC=NOMREC;
	    	this.codDoc= codDoc;
